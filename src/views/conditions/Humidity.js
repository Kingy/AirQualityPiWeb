...
const humidityConfig = {
  thresholds: [
    { maxValue: 35, className: 'blue' }, // Cold
    { maxValue: 55, className: 'green' }, // Moderate
    { maxValue: 75, className: 'yellow' }, // Warm
    { maxValue: Infinity, className: 'red' }, // Hot
  ],
}

const humidityData = [
  { date: '2024-02-26', value: 81 },
  { date: '2024-02-27', value: 57 },
  { date: '2024-02-28', value: 44 },
  { date: '2024-02-29', value: 67 },
  { date: '2024-03-01', value: 56 },
  { date: '2024-03-02', value: 45 },
  { date: '2024-03-03', value: 88 },
  { date: '2024-03-04', value: 33 },
  // More data
]
      ...
      <CRow>
        <CCol xs={4}>
          <CWidgetStatsF
            ...
            color="success"
            padding={false}
            icon={<FontAwesomeIcon icon={faDroplet} style={{ color: 'success' }} size="lg" />}
      ...
      <CRow>
        <CCol xs={6}>
          <CCard className="mb-4">
            <CCardHeader>7 day Humidity</CCardHeader>
            <CCardBody>
              <CChartBar
                data={{
        ...
        <CCol xs={6}>
          <CCard className="mb-4">
            <CCardHeader>Monthly Averages</CCardHeader>
            <CCardBody>
              <DataCalendar data={humidityData} config={humidityConfig} />
            </CCardBody>
          </CCard>
        </CCol>
      </CRow>
